        ...
        <div class="col-md-10 offset-md-1 py-2">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <router-link :to="{ name: 'collection_detail' }">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" id="path" placeholder="Path Prefix" v-model="collection.PathPrefix" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="name" class="form-control" id="path" placeholder="Content Type" v-model="collection.ContentType" />
                            </div>
                        </div>
                    </div>
                </form>
...
export default {
    ...
    methods: {
        fetchData() {
            ...
            axios.get("http://localhost:3000/itinerary/collection/"+this.$route.params.id)
                .then((response) => {
                    ...
                    this.cachedName = this.collection.Name;
                    this.loading = false;
                })
                .catch((error) => {
        ...
        persistCollection() {
            axios.post("http://localhost:3000/itinerary/collection/"+this.$route.params.id, {
                ...
                .then((response) => {
                    this.collection = response.data;
                    this.successMessage = "Collection has been updated";
                    this.$router.push({
